...
import { LDrawLoader } from './gfx/LDrawLoader.js';
...
function initOffice(onLoad, onProgress, onError) {
    ...
    lDrawLoader
        .setPath( "ldraw/" )
        .load( "models/office.ldr_Packed.mpd", function ( group2 ) {
